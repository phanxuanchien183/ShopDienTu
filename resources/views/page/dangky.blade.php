                    ...
                    <div class="login-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-12 mb-20">
                                ...
                                <input class="mb-0" type="text" name="fullname" placeholder="Full Name">
                            </div>
                            <div class="col-md-12 col-12 mb-20">
                                <label>Number phone</label>
                                <input class="mb-0" type="text" name="phone" placeholder="Number phone">
                            </div>
                            ...
                            <div class="col-md-12 mb-20">
                                <label>Address</label>
                                <input class="mb-0" type="adress" name="adress" placeholder=" Address">
                            </div>
