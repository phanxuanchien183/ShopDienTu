                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 text-center pt-xs-30">
                            ...
                            @foreach ($slide as $item)
                                 <a href="#">
                                    <img src="uiStore/images/banner/{{$item->image}}" alt="">
                                </a>
                            @endforeach
                ...
                <div class="container">
                    ...
                    <div class="tab-content">
                                            ...
                                            <div class="single-product-wrap">
                                                <div class="product-image">
                                                    <a href="{{route('chitietsanpham',$sp->id)}}">
                                                        <img style="height: 137px; width: 206px" src="uiStore/images/product/smallsize/{{$sp->image}}" alt="Li's Product Image">
                                                    </a>
                                                    ...
                                                    <div class="product_desc_info">
                                                        <div class="product-review">
                                                            {{-- <h5 class="manufacturer">
                                                                <a href="shop-left-sidebar.html">{{$sp->name}}</a>
                                                            </h5> --}}
                        ...
                        <div id="li-bestseller-product" class="tab-pane" role="tabpanel">
                            <div class="row">
                                <div class="product-active owl-carousel">
                                   @foreach ($best_product as $bestproduct)
                                   <div class="col-lg-12">
                                    <!-- single-product-wrap start -->
                                    <div class="single-product-wrap">
                                        <div class="product-image">
                                            <a href="single-product.html">
                                                <img style="height: 137px; width: 206px" src="uiStore/images/product/smallsize/{{$bestproduct->image}}" alt="Li's Product Image">
                                            </a>
                                            {{-- <span class="sticker">New</span> --}}
                                        </div>
                                        <div class="product_desc">
                                            <div class="product_desc_info">
                                                <div class="product-review">
                                                    {{-- <h5 class="manufacturer">
                                                        <a href="shop-left-sidebar.html">{{$bestproduct->name}}</a>
                                                    </h5> --}}
                                                    <div class="rating-box">
                                                        <ul class="rating">
                                                            <li><i class="fa fa-star-o"></i></li>
                                ...
                                <div class="product-active owl-carousel">
                                    @foreach ($sell_product as  $sell)
                                        ...
                                        <div class="single-product-wrap">
                                            <div class="product-image">
                                                <a href="single-product.html">
                                                    <img style="height: 137px; width: 206px" src="uiStore/images/product/smallsize/{{$sell->image}}" alt="Li's Product Image">
                                                </a>
                                                {{-- <span class="sticker">New</span> --}}
                                            </div>
                                            <div class="product_desc">
                                                <div class="product_desc_info">
                                                    <div class="product-review">
                                                        {{-- <h5 class="manufacturer">
                                                            <a href="shop-left-sidebar.html">{{$sell->name}}</a>
                                                        </h5> --}}
                                                        <div class="rating-box">
                                                            <ul class="rating">
                                                                <li><i class="fa fa-star-o"></i></li>
                                ...
                                <div class="product-active owl-carousel">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="single-product-wrap">
                                            <div class="product-image">
                                                <a href="single-product.html">
                                                    <img style="height: 137px; width: 206px" src="uiStore/images/product/smallsize/{{$lt->image}}" alt="Li's Product Image">
                                                </a>
                                                <span class="sticker">New</span>
                                            </div>
                                            <div class="product_desc">
                                ...
                                <div class="product-active owl-carousel">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="single-product-wrap">
                                            <div class="product-image">
                                                <a href="single-product.html">
                                                    <img style="height: 137px; width: 206px" src="uiStore/images/product/smallsize/{{$tv->image}}" alt="Li's Product Image">
                                                </a>
                                                <span class="sticker">New</span>
                                            </div>
                                            <div class="product_desc">
                                                ...
                                                <div class="add-actions">
                                                    <ul class="add-actions-link">
                                                        <li class="add-cart active"><a href="{{route('themgiohang',$tv->id)}}">Add to cart</a></li>
                                                        <li><a class="links-details" href="wishlist.html"><i class="fa fa-heart-o"></i></a></li>
                                                        <li><a href="#" title="quick view" class="quick-view-btn" data-toggle="modal" data-target="#exampleModalCenter"><i class="fa fa-eye"></i></a></li>
                                                    </ul>
                                                </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="li-section-title">
                                <h2>
                                    <span>Mặt hàng HOT</span>
                                </h2>
                            </div>
                            <div class="row">
                                <div class="product-active owl-carousel">
                                    @foreach ($best_product as $spbest)
                                    <div class="col-lg-12">
                                        <!-- single-product-wrap start -->
                                        <div class="single-product-wrap">
                                            <div class="product-image">
                                                <a href="single-product.html">
                                                    <img style="height: 137px; width: 206px" src="uiStore/images/product/smallsize/{{$spbest->image}}" alt="Li's Product Image">
                                                </a>
                                                <span class="sticker">New</span>
                                            </div>
                                            <div class="product_desc">
                                                <div class="product_desc_info">
                                                    <div class="product-review">
                                                        <h5 class="manufacturer">
                                                            <a href="shop-left-sidebar.html">{{$spbest->name}}</a>
                                                        </h5>
                                                        <div class="rating-box">
                                                            <ul class="rating">
                                                                <li><i class="fa fa-star-o"></i></li>
                                                    ...
                                                    <h4><a class="product_name" href="single-product.html">Accusantium dolorem1</a></h4>
                                                    <div class="price-box">
                                                        <span class="new-price">${{$spbest->promotion_price}}</span>
                                                    </div>
                                                </div>
                                                <div class="add-actions">
                                                    <ul class="add-actions-link">
